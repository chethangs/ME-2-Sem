...
def c_g(field,y,total_entropy):
	...
	for i in range(len(positive_list)):
		entropy = c_e(positive_list[i],negative_list[i])
...
for i in range(len(data)):
	gain.append(c_g(data[i],y,total_entropy))
print(gain)